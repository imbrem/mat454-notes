...
\begin{enumerate}
  ...
  There are, however, three exceptional points of \(\mbb{C}\) over which there's only a single point: namely, the points given by the cube roots of unity. Because, over these points, the multi-valued function only takes the value zero.
