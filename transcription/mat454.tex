...
\[\frac{1}{2\pi i}\int_\gamma\frac{d(1 - x^3)^{1/3}}{(1 - x^3)^{1/3}} = -\frac{1}{2\pi i}\int_\gamma\frac{x^2dx}{1 - x^3}\]
Letting \(f(x) = \frac{x^2}{1 - x^3}\), we have that the above is equal to
\[-(\Res(f, 1) + \Res(f, j) + \Res(f, j^2)) = -3 \cdot -\frac{1}{3} = 1\]
as the residue at \(x = 1\) is the coefficient of \(\frac{1}{t}\) in
\[\frac{(1 + t)^2}{1 - (1 + t)^3} = -\frac{(1 + t)^2}{3t + O(t^2)}\]
