...
Given \(a_2, a_4\) given only that \(P(x) = 4x^2 - 20a_2x - 28a_4\) has three distinct roots, there is a discrete subgroup \(\Gamma\) of \(\mbb{C}\) such that \(a_2, a_4\) are given by Equation \ref{equation:meromorphic_weierstrass}.
\end{theorem}
