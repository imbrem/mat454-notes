...
\end{equation}
Assume the RHS \(p(x)\) has three distinct roots so the equation defines a nonsingular curve (note that every nonsingular cubic has a equation of this form in suitable affine coordinates: \textbf{Weierstrass normal form}).
