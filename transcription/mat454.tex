...
\begin{enumerate}
  ...
  \item The Riemann sphere \(S^2 = P^1(\mbb{C})\). Note this is compact.

  \item \(\mbb{C} \setminus \mbb{Z}\) with \(\mbb{Z}\) taken as an additive subgroup of \(\mbb{Z}\): equivalence classes of points where the difference is in \(\mbb{Z}\).
