...
\end{tikzcd}
\end{equation}
So, let's suppose for a minute that \(a_2, a_4\), the coefficients, come from a discrete subgroup \(\Gamma = \gen{e_1, e_2}\) of \(\mbb{C}\), where \(e_1, e_2\) are linearly independent, according to the formula we talked about earlier in the year.
